...
def wowza(input_here):
    ...
    #step 2 list all word and price by using tuple
    necessary = {'Noodle_cup':20, 'Fried_egg':24, 'Pad_thai':40, 'Krapao_extra':50, 'water':6}
    not_necessary = {'Chocolate':22, 'Pepsi':18, 'Lemon_tea':15}
    
    #step 3 split each food into list
    splitword = input_here.split(" ")
    
    #step 4 making summary of all
    summary_not_ness = 0
    summary_ness = 0
    notincatalog = 0
    
    #step 5 making loop of list
    for i in splitword:
        
        #step 6 checking type of food
